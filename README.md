...
Меня зовут Павел, я QA Engineer.
- :rocket: У меня более 6-х лет опыта ручного тестирования, а также небольшой опыт автотестов на Python и Java
...
| :world_map: <a target="_blank" href="[https://github.com/Milson-PS/int_alph]">UI, API autotests example</a> 
https://github.com/Milson-PS/int_alph
